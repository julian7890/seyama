...
type formDataType = {
  ...
  jp: {
    description: string;
    location: string;
    performer: [role: string, name: string];
  };
  en: {
    description: string;
    location: string;
...
export default function EditSchedule({ params }: { params: { id: string } }) {
  ...
  const [formData, setFormData] = useState({
    date: "",
    url: "",
    jp: { description: "", location: "", performer: [{ role: "", name: "" }] },
    en: { description: "", location: "", performer: [{ role: "", name: "" }] },
  });
      ...
      <div className="flex gap-2" key={`JP${i}`}>
        <div className="flex flex-col">
          ...
          <input
            ...
            name={`roleJP${i}`}
            size={9}
            value={formData.jp.performer[i].role}
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            name={`nameJP${i}`}
            size={19}
            value={formData.jp.performer[i].name}
            onChange={performerHandler}
          />
        </div>
      </div>
      ...
      <div className="flex gap-2" key={`EN${i}`}>
        <div className="flex flex-col">
          ...
          <input
            ...
            name={`roleEN${i}`}
            size={9}
            value={formData.en.performer[i].role}
            onChange={performerHandler}
          />
        </div>
        <div className="flex flex-col">
          ...
          <input
            ...
            name={`nameEN${i}`}
            size={19}
            value={formData.en.performer[i].name}
            onChange={performerHandler}
          />
        </div>
      </div>
